...
grep -A$(( $2+10 )) 'CAP energies' $1 | tail -$2 | awk {'print $1, $4, $5'} > $1.data


grep -A$(( $2+7 )) 'Energy corrections' $1 | tail -$2 | awk {'print $4, $5, -$4/$1, -$5/$1, $1*sqrt(($4/$1)^2+($5/$1)^2)'} > $1.corrections.data
