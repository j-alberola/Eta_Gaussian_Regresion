...
new_points2 = np.linspace(x_min, x_max, 100000).reshape(-1, 1)
...
for x_star in new_points:
    ...
    # Calculate the derivative for this specific point
    Acquisition = LB_acquisition(7.0,x_star_reshaped)
...
def multi_start_minimize_LB(n_starts=100):
...
def multi_start_maximize_EI(n_starts=1000):
